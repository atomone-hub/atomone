...
func TestDisplay(t *testing.T) {
	...
	require.NoError(err)
	expectedPrefix := `{"@type":"/atomone.crypto.multisig.LegacyAminoPubKey","threshold":2,"public_keys":[{"@type":"/atomone.crypto.secp256k1.PubKey"`
	require.True(strings.HasPrefix(string(bz), expectedPrefix))
	// Example output:
	// {"@type":"/atomone.crypto.multisig.LegacyAminoPubKey","threshold":2,"public_keys":[{"@type":"/atomone.crypto.secp256k1.PubKey","key":"AymUY3J2HKIyy9cbpGKcBFUTuDQsRH9NO/orKF/0WQ76"},{"@type":"/atomone.crypto.secp256k1.PubKey","key":"AkvnCDzSYF+tQV/FoI217V7CDIRPzjJj7zBE2nw7x3xT"},{"@type":"/atomone.crypto.secp256k1.PubKey","key":"A0yiqgcM5EB1i0h79+sQp+C0jLPFnT3+dFmdZmGa+H1s"}]}
}
