...
func init() {
	file_atomone_vesting_v1beta1_tx_proto_init()
	md_MsgCreateVestingAccount = File_atomone_vesting_v1beta1_tx_proto.Messages().ByName("MsgCreateVestingAccount")
...
func (x *MsgCreateVestingAccount) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_vesting_v1beta1_tx_proto_msgTypes[0]
...
func (x *fastReflection_MsgCreateVestingAccount) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "atomone.vesting.v1beta1.MsgCreateVestingAccount.from_address":
		return x.FromAddress != ""
	case "atomone.vesting.v1beta1.MsgCreateVestingAccount.to_address":
		return x.ToAddress != ""
	case "atomone.vesting.v1beta1.MsgCreateVestingAccount.amount":
		return len(x.Amount) != 0
	case "atomone.vesting.v1beta1.MsgCreateVestingAccount.end_time":
		return x.EndTime != int64(0)
	case "atomone.vesting.v1beta1.MsgCreateVestingAccount.delayed":
		return x.Delayed != false
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.vesting.v1beta1.MsgCreateVestingAccount"))
		}
		panic(fmt.Errorf("message atomone.vesting.v1beta1.MsgCreateVestingAccount does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgCreateVestingAccount) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.vesting.v1beta1.MsgCreateVestingAccount does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgCreateVestingAccount) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "atomone.vesting.v1beta1.MsgCreateVestingAccount.from_address":
		panic(fmt.Errorf("field from_address of message atomone.vesting.v1beta1.MsgCreateVestingAccount is not mutable"))
	case "atomone.vesting.v1beta1.MsgCreateVestingAccount.to_address":
		panic(fmt.Errorf("field to_address of message atomone.vesting.v1beta1.MsgCreateVestingAccount is not mutable"))
	case "atomone.vesting.v1beta1.MsgCreateVestingAccount.end_time":
		panic(fmt.Errorf("field end_time of message atomone.vesting.v1beta1.MsgCreateVestingAccount is not mutable"))
	case "atomone.vesting.v1beta1.MsgCreateVestingAccount.delayed":
		panic(fmt.Errorf("field delayed of message atomone.vesting.v1beta1.MsgCreateVestingAccount is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.vesting.v1beta1.MsgCreateVestingAccount"))
		}
...
func (x *fastReflection_MsgCreateVestingAccount) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.vesting.v1beta1.MsgCreateVestingAccount", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_atomone_vesting_v1beta1_tx_proto_init()
	md_MsgCreateVestingAccountResponse = File_atomone_vesting_v1beta1_tx_proto.Messages().ByName("MsgCreateVestingAccountResponse")
}
...
func (x *MsgCreateVestingAccountResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_vesting_v1beta1_tx_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_MsgCreateVestingAccountResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.vesting.v1beta1.MsgCreateVestingAccountResponse"))
		}
		panic(fmt.Errorf("message atomone.vesting.v1beta1.MsgCreateVestingAccountResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgCreateVestingAccountResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.vesting.v1beta1.MsgCreateVestingAccountResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgCreateVestingAccountResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.vesting.v1beta1.MsgCreateVestingAccountResponse", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_atomone_vesting_v1beta1_tx_proto_init()
	md_MsgCreatePermanentLockedAccount = File_atomone_vesting_v1beta1_tx_proto.Messages().ByName("MsgCreatePermanentLockedAccount")
...
func (x *MsgCreatePermanentLockedAccount) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_vesting_v1beta1_tx_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_MsgCreatePermanentLockedAccount) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "atomone.vesting.v1beta1.MsgCreatePermanentLockedAccount.from_address":
		return x.FromAddress != ""
	case "atomone.vesting.v1beta1.MsgCreatePermanentLockedAccount.to_address":
		return x.ToAddress != ""
	case "atomone.vesting.v1beta1.MsgCreatePermanentLockedAccount.amount":
		return len(x.Amount) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.vesting.v1beta1.MsgCreatePermanentLockedAccount"))
		}
		panic(fmt.Errorf("message atomone.vesting.v1beta1.MsgCreatePermanentLockedAccount does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgCreatePermanentLockedAccount) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.vesting.v1beta1.MsgCreatePermanentLockedAccount does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgCreatePermanentLockedAccount) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "atomone.vesting.v1beta1.MsgCreatePermanentLockedAccount.amount":
		...
		return protoreflect.ValueOfList(value)
	case "atomone.vesting.v1beta1.MsgCreatePermanentLockedAccount.from_address":
		panic(fmt.Errorf("field from_address of message atomone.vesting.v1beta1.MsgCreatePermanentLockedAccount is not mutable"))
	case "atomone.vesting.v1beta1.MsgCreatePermanentLockedAccount.to_address":
		panic(fmt.Errorf("field to_address of message atomone.vesting.v1beta1.MsgCreatePermanentLockedAccount is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.vesting.v1beta1.MsgCreatePermanentLockedAccount"))
		}
...
func (x *fastReflection_MsgCreatePermanentLockedAccount) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.vesting.v1beta1.MsgCreatePermanentLockedAccount", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_atomone_vesting_v1beta1_tx_proto_init()
	md_MsgCreatePermanentLockedAccountResponse = File_atomone_vesting_v1beta1_tx_proto.Messages().ByName("MsgCreatePermanentLockedAccountResponse")
}
...
func (x *MsgCreatePermanentLockedAccountResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_vesting_v1beta1_tx_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_MsgCreatePermanentLockedAccountResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.vesting.v1beta1.MsgCreatePermanentLockedAccountResponse"))
		}
		panic(fmt.Errorf("message atomone.vesting.v1beta1.MsgCreatePermanentLockedAccountResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgCreatePermanentLockedAccountResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.vesting.v1beta1.MsgCreatePermanentLockedAccountResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgCreatePermanentLockedAccountResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.vesting.v1beta1.MsgCreatePermanentLockedAccountResponse", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_atomone_vesting_v1beta1_tx_proto_init()
	md_MsgCreatePeriodicVestingAccount = File_atomone_vesting_v1beta1_tx_proto.Messages().ByName("MsgCreatePeriodicVestingAccount")
...
func (x *MsgCreatePeriodicVestingAccount) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_vesting_v1beta1_tx_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_MsgCreatePeriodicVestingAccount) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccount.from_address":
		return x.FromAddress != ""
	case "atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccount.to_address":
		return x.ToAddress != ""
	case "atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccount.start_time":
		return x.StartTime != int64(0)
	case "atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccount.vesting_periods":
		return len(x.VestingPeriods) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccount"))
		}
		panic(fmt.Errorf("message atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccount does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgCreatePeriodicVestingAccount) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccount does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgCreatePeriodicVestingAccount) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccount.vesting_periods":
		...
		return protoreflect.ValueOfList(value)
	case "atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccount.from_address":
		panic(fmt.Errorf("field from_address of message atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccount is not mutable"))
	case "atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccount.to_address":
		panic(fmt.Errorf("field to_address of message atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccount is not mutable"))
	case "atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccount.start_time":
		panic(fmt.Errorf("field start_time of message atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccount is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccount"))
		}
...
func (x *fastReflection_MsgCreatePeriodicVestingAccount) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccount", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_atomone_vesting_v1beta1_tx_proto_init()
	md_MsgCreatePeriodicVestingAccountResponse = File_atomone_vesting_v1beta1_tx_proto.Messages().ByName("MsgCreatePeriodicVestingAccountResponse")
}
...
func (x *MsgCreatePeriodicVestingAccountResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_vesting_v1beta1_tx_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_MsgCreatePeriodicVestingAccountResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccountResponse"))
		}
		panic(fmt.Errorf("message atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccountResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgCreatePeriodicVestingAccountResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccountResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgCreatePeriodicVestingAccountResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccountResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: atomone/vesting/v1beta1/tx.proto
...
func (*MsgCreateVestingAccount) Descriptor() ([]byte, []int) {
	return file_atomone_vesting_v1beta1_tx_proto_rawDescGZIP(), []int{0}
}
...
func (*MsgCreateVestingAccountResponse) Descriptor() ([]byte, []int) {
	return file_atomone_vesting_v1beta1_tx_proto_rawDescGZIP(), []int{1}
}
...
func (*MsgCreatePermanentLockedAccount) Descriptor() ([]byte, []int) {
	return file_atomone_vesting_v1beta1_tx_proto_rawDescGZIP(), []int{2}
}
...
func (*MsgCreatePermanentLockedAccountResponse) Descriptor() ([]byte, []int) {
	return file_atomone_vesting_v1beta1_tx_proto_rawDescGZIP(), []int{3}
}
...
func (*MsgCreatePeriodicVestingAccount) Descriptor() ([]byte, []int) {
	return file_atomone_vesting_v1beta1_tx_proto_rawDescGZIP(), []int{4}
}
...
func (*MsgCreatePeriodicVestingAccountResponse) Descriptor() ([]byte, []int) {
	return file_atomone_vesting_v1beta1_tx_proto_rawDescGZIP(), []int{5}
}

var File_atomone_vesting_v1beta1_tx_proto protoreflect.FileDescriptor

var file_atomone_vesting_v1beta1_tx_proto_rawDesc = []byte{
	0x0a, 0x20, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2f, 0x76, 0x65, 0x73, 0x74, 0x69, 0x6e,
	0x67, 0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x74, 0x78, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x12, 0x17, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2e, 0x76, 0x65, 0x73, 0x74,
	0x69, 0x6e, 0x67, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x1a, 0x14, 0x67, 0x6f, 0x67,
	0x6f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x1a, 0x1f, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2f, 0x62, 0x61, 0x73, 0x65, 0x2f,
	...
	,
	...
	0x66, 0x72, 0x6f, 0x6d, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x38, 0x0a, 0x0a, 0x74,
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x6b, 0x0a, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18,
	0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2e,
	0x62, 0x61, 0x73, 0x65, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x43, 0x6f, 0x69,
	0x6e, 0x42, 0x37, 0xc8, 0xde, 0x1f, 0x00, 0xaa, 0xdf, 0x1f, 0x2a, 0x67, 0x69, 0x74, 0x68, 0x75,
	...
	0x6e, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x65, 0x6e, 0x64, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x04,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x65, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x18, 0x0a,
	0x07, 0x64, 0x65, 0x6c, 0x61, 0x79, 0x65, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07,
	0x64, 0x65, 0x6c, 0x61, 0x79, 0x65, 0x64, 0x3a, 0x39, 0xe8, 0xa0, 0x1f, 0x01, 0x82, 0xe7, 0xb0,
	0x2a, 0x0c, 0x66, 0x72, 0x6f, 0x6d, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x8a, 0xe7,
	0xb0, 0x2a, 0x1f, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2f, 0x4d, 0x73, 0x67, 0x43, 0x72,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xbe, 0x02, 0x0a, 0x1f, 0x4d, 0x73, 0x67, 0x43, 0x72, 0x65,
	...
	0x52, 0x09, 0x74, 0x6f, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x6b, 0x0a, 0x06, 0x61,
	...
	0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x3a, 0x3c, 0xe8, 0xa0, 0x1f, 0x01, 0x82, 0xe7,
	0xb0, 0x2a, 0x0c, 0x66, 0x72, 0x6f, 0x6d, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x8a,
	0xe7, 0xb0, 0x2a, 0x22, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2f, 0x4d, 0x73, 0x67, 0x43,
	0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x65, 0x72, 0x6d, 0x4c, 0x6f, 0x63, 0x6b, 0x65, 0x64, 0x41,
	...
	0x65, 0x22, 0x9a, 0x02, 0x0a, 0x1f, 0x4d, 0x73, 0x67, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50,
	...
	0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x72, 0x74,
	0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x73, 0x74, 0x61,
	0x72, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x53, 0x0a, 0x0f, 0x76, 0x65, 0x73, 0x74, 0x69, 0x6e,
	0x67, 0x5f, 0x70, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x1f, 0x2e, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2e, 0x76, 0x65, 0x73, 0x74, 0x69, 0x6e,
	...
	,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x9a, 0x01, 0x0a, 0x1c, 0x43, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x50, 0x65, 0x72, 0x6d, 0x61, 0x6e, 0x65, 0x6e, 0x74, 0x4c, 0x6f, 0x63, 0x6b, 0x65, 0x64,
	0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x38, 0x2e, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e,
	0x65, 0x2e, 0x76, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61,
	0x31, 0x2e, 0x4d, 0x73, 0x67, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x65, 0x72, 0x6d, 0x61,
	0x6e, 0x65, 0x6e, 0x74, 0x4c, 0x6f, 0x63, 0x6b, 0x65, 0x64, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e,
	0x74, 0x1a, 0x40, 0x2e, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2e, 0x76, 0x65, 0x73, 0x74,
	...
	0x6e, 0x73, 0x65, 0x12, 0x9a, 0x01, 0x0a, 0x1c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x65,
	0x72, 0x69, 0x6f, 0x64, 0x69, 0x63, 0x56, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x41, 0x63, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x12, 0x38, 0x2e, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2e, 0x76,
	0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2e, 0x4d,
	0x73, 0x67, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x69, 0x63,
	0x56, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x1a, 0x40,
	0x2e, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2e, 0x76, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67,
	...
	0x1a, 0x05, 0x80, 0xe7, 0xb0, 0x2a, 0x01, 0x42, 0xef, 0x01, 0x0a, 0x1b, 0x63, 0x6f, 0x6d, 0x2e,
	0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2e, 0x76, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x2e,
	...
	0x6e, 0x65, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2f, 0x76,
	...
	,
}

var (
	file_atomone_vesting_v1beta1_tx_proto_rawDescOnce sync.Once
	file_atomone_vesting_v1beta1_tx_proto_rawDescData = file_atomone_vesting_v1beta1_tx_proto_rawDesc
)

func file_atomone_vesting_v1beta1_tx_proto_rawDescGZIP() []byte {
	file_atomone_vesting_v1beta1_tx_proto_rawDescOnce.Do(func() {
		file_atomone_vesting_v1beta1_tx_proto_rawDescData = protoimpl.X.CompressGZIP(file_atomone_vesting_v1beta1_tx_proto_rawDescData)
	})
	return file_atomone_vesting_v1beta1_tx_proto_rawDescData
}

var file_atomone_vesting_v1beta1_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_atomone_vesting_v1beta1_tx_proto_goTypes = []interface{}{
	(*MsgCreateVestingAccount)(nil),                 // 0: atomone.vesting.v1beta1.MsgCreateVestingAccount
	(*MsgCreateVestingAccountResponse)(nil),         // 1: atomone.vesting.v1beta1.MsgCreateVestingAccountResponse
	(*MsgCreatePermanentLockedAccount)(nil),         // 2: atomone.vesting.v1beta1.MsgCreatePermanentLockedAccount
	(*MsgCreatePermanentLockedAccountResponse)(nil), // 3: atomone.vesting.v1beta1.MsgCreatePermanentLockedAccountResponse
	(*MsgCreatePeriodicVestingAccount)(nil),         // 4: atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccount
	(*MsgCreatePeriodicVestingAccountResponse)(nil), // 5: atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccountResponse
	(*v1beta1.Coin)(nil),                            // 6: atomone.base.v1beta1.Coin
	(*Period)(nil),                                  // 7: atomone.vesting.v1beta1.Period
}
var file_atomone_vesting_v1beta1_tx_proto_depIdxs = []int32{
	6, // 0: atomone.vesting.v1beta1.MsgCreateVestingAccount.amount:type_name -> atomone.base.v1beta1.Coin
	6, // 1: atomone.vesting.v1beta1.MsgCreatePermanentLockedAccount.amount:type_name -> atomone.base.v1beta1.Coin
	7, // 2: atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccount.vesting_periods:type_name -> atomone.vesting.v1beta1.Period
	0, // 3: atomone.vesting.v1beta1.Msg.CreateVestingAccount:input_type -> atomone.vesting.v1beta1.MsgCreateVestingAccount
	2, // 4: atomone.vesting.v1beta1.Msg.CreatePermanentLockedAccount:input_type -> atomone.vesting.v1beta1.MsgCreatePermanentLockedAccount
	4, // 5: atomone.vesting.v1beta1.Msg.CreatePeriodicVestingAccount:input_type -> atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccount
	1, // 6: atomone.vesting.v1beta1.Msg.CreateVestingAccount:output_type -> atomone.vesting.v1beta1.MsgCreateVestingAccountResponse
	3, // 7: atomone.vesting.v1beta1.Msg.CreatePermanentLockedAccount:output_type -> atomone.vesting.v1beta1.MsgCreatePermanentLockedAccountResponse
	5, // 8: atomone.vesting.v1beta1.Msg.CreatePeriodicVestingAccount:output_type -> atomone.vesting.v1beta1.MsgCreatePeriodicVestingAccountResponse
...
func init() { file_atomone_vesting_v1beta1_tx_proto_init() }
func file_atomone_vesting_v1beta1_tx_proto_init() {
	if File_atomone_vesting_v1beta1_tx_proto != nil {
		return
	}
	file_atomone_vesting_v1beta1_vesting_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_atomone_vesting_v1beta1_tx_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_atomone_vesting_v1beta1_tx_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_atomone_vesting_v1beta1_tx_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_atomone_vesting_v1beta1_tx_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_atomone_vesting_v1beta1_tx_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_atomone_vesting_v1beta1_tx_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_atomone_vesting_v1beta1_tx_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_atomone_vesting_v1beta1_tx_proto_goTypes,
		DependencyIndexes: file_atomone_vesting_v1beta1_tx_proto_depIdxs,
		MessageInfos:      file_atomone_vesting_v1beta1_tx_proto_msgTypes,
	}.Build()
	File_atomone_vesting_v1beta1_tx_proto = out.File
	file_atomone_vesting_v1beta1_tx_proto_rawDesc = nil
	file_atomone_vesting_v1beta1_tx_proto_goTypes = nil
	file_atomone_vesting_v1beta1_tx_proto_depIdxs = nil
}
