...
func init() {
	file_atomone_tx_config_v1_config_proto_init()
	md_Config = File_atomone_tx_config_v1_config_proto.Messages().ByName("Config")
...
func (x *Config) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_tx_config_v1_config_proto_msgTypes[0]
...
func (x *fastReflection_Config) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "atomone.tx.config.v1.Config.skip_ante_handler":
		return x.SkipAnteHandler != false
	case "atomone.tx.config.v1.Config.skip_post_handler":
		return x.SkipPostHandler != false
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.tx.config.v1.Config"))
		}
		panic(fmt.Errorf("message atomone.tx.config.v1.Config does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Config) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.tx.config.v1.Config does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Config) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "atomone.tx.config.v1.Config.skip_ante_handler":
		panic(fmt.Errorf("field skip_ante_handler of message atomone.tx.config.v1.Config is not mutable"))
	case "atomone.tx.config.v1.Config.skip_post_handler":
		panic(fmt.Errorf("field skip_post_handler of message atomone.tx.config.v1.Config is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.tx.config.v1.Config"))
		}
...
func (x *fastReflection_Config) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.tx.config.v1.Config", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: atomone/tx/config/v1/config.proto
...
func (*Config) Descriptor() ([]byte, []int) {
	return file_atomone_tx_config_v1_config_proto_rawDescGZIP(), []int{0}
}
...
var File_atomone_tx_config_v1_config_proto protoreflect.FileDescriptor

var file_atomone_tx_config_v1_config_proto_rawDesc = []byte{
	0x0a, 0x21, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2f, 0x74, 0x78, 0x2f, 0x63, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x2f, 0x76, 0x31, 0x2f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x12, 0x14, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2e, 0x74, 0x78, 0x2e,
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x76, 0x31, 0x1a, 0x21, 0x61, 0x74, 0x6f, 0x6d, 0x6f,
	0x6e, 0x65, 0x2f, 0x61, 0x70, 0x70, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31, 0x2f,
	0x6d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x92, 0x01, 0x0a,
	...
	0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2f, 0x78, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x2f, 0x74,
	0x78, 0x42, 0xdc, 0x01, 0x0a, 0x18, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e,
	0x65, 0x2e, 0x74, 0x78, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x76, 0x31, 0x42, 0x0b,
	...
	0x69, 0x2f, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2f, 0x74, 0x78, 0x2f, 0x63, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x2f, 0x76, 0x31, 0x3b, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x76, 0x31, 0xa2,
	0x02, 0x03, 0x41, 0x54, 0x43, 0xaa, 0x02, 0x14, 0x41, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2e,
	0x54, 0x78, 0x2e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x56, 0x31, 0xca, 0x02, 0x14, 0x41,
	0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x5c, 0x54, 0x78, 0x5c, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	0x5c, 0x56, 0x31, 0xe2, 0x02, 0x20, 0x41, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x5c, 0x54, 0x78,
	...
	0x3a, 0x3a, 0x54, 0x78, 0x3a, 0x3a, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x3a, 0x3a, 0x56, 0x31,
	0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_atomone_tx_config_v1_config_proto_rawDescOnce sync.Once
	file_atomone_tx_config_v1_config_proto_rawDescData = file_atomone_tx_config_v1_config_proto_rawDesc
)

func file_atomone_tx_config_v1_config_proto_rawDescGZIP() []byte {
	file_atomone_tx_config_v1_config_proto_rawDescOnce.Do(func() {
		file_atomone_tx_config_v1_config_proto_rawDescData = protoimpl.X.CompressGZIP(file_atomone_tx_config_v1_config_proto_rawDescData)
	})
	return file_atomone_tx_config_v1_config_proto_rawDescData
}

var file_atomone_tx_config_v1_config_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_atomone_tx_config_v1_config_proto_goTypes = []interface{}{
	(*Config)(nil), // 0: atomone.tx.config.v1.Config
}
var file_atomone_tx_config_v1_config_proto_depIdxs = []int32{
...
func init() { file_atomone_tx_config_v1_config_proto_init() }
func file_atomone_tx_config_v1_config_proto_init() {
	if File_atomone_tx_config_v1_config_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_atomone_tx_config_v1_config_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Config); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_atomone_tx_config_v1_config_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_atomone_tx_config_v1_config_proto_goTypes,
		DependencyIndexes: file_atomone_tx_config_v1_config_proto_depIdxs,
		MessageInfos:      file_atomone_tx_config_v1_config_proto_msgTypes,
	}.Build()
	File_atomone_tx_config_v1_config_proto = out.File
	file_atomone_tx_config_v1_config_proto_rawDesc = nil
	file_atomone_tx_config_v1_config_proto_goTypes = nil
	file_atomone_tx_config_v1_config_proto_depIdxs = nil
}
