...
func init() {
	file_atomone_capability_v1beta1_capability_proto_init()
	md_Capability = File_atomone_capability_v1beta1_capability_proto.Messages().ByName("Capability")
...
func (x *Capability) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_capability_v1beta1_capability_proto_msgTypes[0]
...
func (x *fastReflection_Capability) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "atomone.capability.v1beta1.Capability.index":
		return x.Index != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.capability.v1beta1.Capability"))
		}
		panic(fmt.Errorf("message atomone.capability.v1beta1.Capability does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Capability) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.capability.v1beta1.Capability does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Capability) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "atomone.capability.v1beta1.Capability.index":
		panic(fmt.Errorf("field index of message atomone.capability.v1beta1.Capability is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.capability.v1beta1.Capability"))
		}
...
func (x *fastReflection_Capability) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.capability.v1beta1.Capability", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_atomone_capability_v1beta1_capability_proto_init()
	md_Owner = File_atomone_capability_v1beta1_capability_proto.Messages().ByName("Owner")
...
func (x *Owner) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_capability_v1beta1_capability_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Owner) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "atomone.capability.v1beta1.Owner.module":
		return x.Module != ""
	case "atomone.capability.v1beta1.Owner.name":
		return x.Name != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.capability.v1beta1.Owner"))
		}
		panic(fmt.Errorf("message atomone.capability.v1beta1.Owner does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Owner) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.capability.v1beta1.Owner does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Owner) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "atomone.capability.v1beta1.Owner.module":
		panic(fmt.Errorf("field module of message atomone.capability.v1beta1.Owner is not mutable"))
	case "atomone.capability.v1beta1.Owner.name":
		panic(fmt.Errorf("field name of message atomone.capability.v1beta1.Owner is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.capability.v1beta1.Owner"))
		}
...
func (x *fastReflection_Owner) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.capability.v1beta1.Owner", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_atomone_capability_v1beta1_capability_proto_init()
	md_CapabilityOwners = File_atomone_capability_v1beta1_capability_proto.Messages().ByName("CapabilityOwners")
...
func (x *CapabilityOwners) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_capability_v1beta1_capability_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_CapabilityOwners) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "atomone.capability.v1beta1.CapabilityOwners.owners":
		return len(x.Owners) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.capability.v1beta1.CapabilityOwners"))
		}
		panic(fmt.Errorf("message atomone.capability.v1beta1.CapabilityOwners does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_CapabilityOwners) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.capability.v1beta1.CapabilityOwners does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_CapabilityOwners) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.capability.v1beta1.CapabilityOwners", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: atomone/capability/v1beta1/capability.proto
...
func (*Capability) Descriptor() ([]byte, []int) {
	return file_atomone_capability_v1beta1_capability_proto_rawDescGZIP(), []int{0}
}
...
func (*Owner) Descriptor() ([]byte, []int) {
	return file_atomone_capability_v1beta1_capability_proto_rawDescGZIP(), []int{1}
}
...
func (*CapabilityOwners) Descriptor() ([]byte, []int) {
	return file_atomone_capability_v1beta1_capability_proto_rawDescGZIP(), []int{2}
}
...
var File_atomone_capability_v1beta1_capability_proto protoreflect.FileDescriptor

var file_atomone_capability_v1beta1_capability_proto_rawDesc = []byte{
	0x0a, 0x2b, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2f, 0x63, 0x61, 0x70, 0x61, 0x62, 0x69,
	0x6c, 0x69, 0x74, 0x79, 0x2f, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x63, 0x61, 0x70,
	0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1a, 0x61,
	0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2e, 0x63, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74,
	...
	,
	...
	0x77, 0x6e, 0x65, 0x72, 0x73, 0x42, 0x8c, 0x02, 0x0a, 0x1e, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x74,
	0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2e, 0x63, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79,
	0x2e, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x42, 0x0f, 0x43, 0x61, 0x70, 0x61, 0x62, 0x69,
	0x6c, 0x69, 0x74, 0x79, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x4f, 0x67, 0x69, 0x74,
	...
	,
}

var (
	file_atomone_capability_v1beta1_capability_proto_rawDescOnce sync.Once
	file_atomone_capability_v1beta1_capability_proto_rawDescData = file_atomone_capability_v1beta1_capability_proto_rawDesc
)

func file_atomone_capability_v1beta1_capability_proto_rawDescGZIP() []byte {
	file_atomone_capability_v1beta1_capability_proto_rawDescOnce.Do(func() {
		file_atomone_capability_v1beta1_capability_proto_rawDescData = protoimpl.X.CompressGZIP(file_atomone_capability_v1beta1_capability_proto_rawDescData)
	})
	return file_atomone_capability_v1beta1_capability_proto_rawDescData
}

var file_atomone_capability_v1beta1_capability_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_atomone_capability_v1beta1_capability_proto_goTypes = []interface{}{
	(*Capability)(nil),       // 0: atomone.capability.v1beta1.Capability
	(*Owner)(nil),            // 1: atomone.capability.v1beta1.Owner
	(*CapabilityOwners)(nil), // 2: atomone.capability.v1beta1.CapabilityOwners
}
var file_atomone_capability_v1beta1_capability_proto_depIdxs = []int32{
	1, // 0: atomone.capability.v1beta1.CapabilityOwners.owners:type_name -> atomone.capability.v1beta1.Owner
...
func init() { file_atomone_capability_v1beta1_capability_proto_init() }
func file_atomone_capability_v1beta1_capability_proto_init() {
	if File_atomone_capability_v1beta1_capability_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_atomone_capability_v1beta1_capability_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_atomone_capability_v1beta1_capability_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Owner); i {
			case 0:
				return &v.state
			case 1:
		...
		file_atomone_capability_v1beta1_capability_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_atomone_capability_v1beta1_capability_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_atomone_capability_v1beta1_capability_proto_goTypes,
		DependencyIndexes: file_atomone_capability_v1beta1_capability_proto_depIdxs,
		MessageInfos:      file_atomone_capability_v1beta1_capability_proto_msgTypes,
	}.Build()
	File_atomone_capability_v1beta1_capability_proto = out.File
	file_atomone_capability_v1beta1_capability_proto_rawDesc = nil
	file_atomone_capability_v1beta1_capability_proto_goTypes = nil
	file_atomone_capability_v1beta1_capability_proto_depIdxs = nil
}
