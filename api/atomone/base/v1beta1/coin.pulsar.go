...
func init() {
	file_atomone_base_v1beta1_coin_proto_init()
	md_Coin = File_atomone_base_v1beta1_coin_proto.Messages().ByName("Coin")
...
func (x *Coin) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_base_v1beta1_coin_proto_msgTypes[0]
...
func (x *fastReflection_Coin) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "atomone.base.v1beta1.Coin.denom":
		return x.Denom != ""
	case "atomone.base.v1beta1.Coin.amount":
		return x.Amount != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.base.v1beta1.Coin"))
		}
		panic(fmt.Errorf("message atomone.base.v1beta1.Coin does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Coin) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.base.v1beta1.Coin does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Coin) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "atomone.base.v1beta1.Coin.denom":
		panic(fmt.Errorf("field denom of message atomone.base.v1beta1.Coin is not mutable"))
	case "atomone.base.v1beta1.Coin.amount":
		panic(fmt.Errorf("field amount of message atomone.base.v1beta1.Coin is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.base.v1beta1.Coin"))
		}
...
func (x *fastReflection_Coin) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.base.v1beta1.Coin", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_atomone_base_v1beta1_coin_proto_init()
	md_DecCoin = File_atomone_base_v1beta1_coin_proto.Messages().ByName("DecCoin")
...
func (x *DecCoin) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_base_v1beta1_coin_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_DecCoin) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "atomone.base.v1beta1.DecCoin.denom":
		return x.Denom != ""
	case "atomone.base.v1beta1.DecCoin.amount":
		return x.Amount != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.base.v1beta1.DecCoin"))
		}
		panic(fmt.Errorf("message atomone.base.v1beta1.DecCoin does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_DecCoin) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.base.v1beta1.DecCoin does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_DecCoin) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "atomone.base.v1beta1.DecCoin.denom":
		panic(fmt.Errorf("field denom of message atomone.base.v1beta1.DecCoin is not mutable"))
	case "atomone.base.v1beta1.DecCoin.amount":
		panic(fmt.Errorf("field amount of message atomone.base.v1beta1.DecCoin is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.base.v1beta1.DecCoin"))
		}
...
func (x *fastReflection_DecCoin) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.base.v1beta1.DecCoin", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_atomone_base_v1beta1_coin_proto_init()
	md_IntProto = File_atomone_base_v1beta1_coin_proto.Messages().ByName("IntProto")
...
func (x *IntProto) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_base_v1beta1_coin_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_IntProto) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "atomone.base.v1beta1.IntProto.int":
		return x.Int != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.base.v1beta1.IntProto"))
		}
		panic(fmt.Errorf("message atomone.base.v1beta1.IntProto does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_IntProto) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.base.v1beta1.IntProto does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_IntProto) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "atomone.base.v1beta1.IntProto.int":
		panic(fmt.Errorf("field int of message atomone.base.v1beta1.IntProto is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.base.v1beta1.IntProto"))
		}
...
func (x *fastReflection_IntProto) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.base.v1beta1.IntProto", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_atomone_base_v1beta1_coin_proto_init()
	md_DecProto = File_atomone_base_v1beta1_coin_proto.Messages().ByName("DecProto")
...
func (x *DecProto) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_base_v1beta1_coin_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_DecProto) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "atomone.base.v1beta1.DecProto.dec":
		return x.Dec != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.base.v1beta1.DecProto"))
		}
		panic(fmt.Errorf("message atomone.base.v1beta1.DecProto does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_DecProto) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.base.v1beta1.DecProto does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_DecProto) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "atomone.base.v1beta1.DecProto.dec":
		panic(fmt.Errorf("field dec of message atomone.base.v1beta1.DecProto is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.base.v1beta1.DecProto"))
		}
...
func (x *fastReflection_DecProto) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.base.v1beta1.DecProto", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: atomone/base/v1beta1/coin.proto
...
func (*Coin) Descriptor() ([]byte, []int) {
	return file_atomone_base_v1beta1_coin_proto_rawDescGZIP(), []int{0}
}
...
func (*DecCoin) Descriptor() ([]byte, []int) {
	return file_atomone_base_v1beta1_coin_proto_rawDescGZIP(), []int{1}
}
...
func (*IntProto) Descriptor() ([]byte, []int) {
	return file_atomone_base_v1beta1_coin_proto_rawDescGZIP(), []int{2}
}
...
func (*DecProto) Descriptor() ([]byte, []int) {
	return file_atomone_base_v1beta1_coin_proto_rawDescGZIP(), []int{3}
}
...
var File_atomone_base_v1beta1_coin_proto protoreflect.FileDescriptor

var file_atomone_base_v1beta1_coin_proto_rawDesc = []byte{
	0x0a, 0x1f, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2f, 0x62, 0x61, 0x73, 0x65, 0x2f, 0x76,
	0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x2f, 0x63, 0x6f, 0x69, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x12, 0x14, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2e, 0x62, 0x61, 0x73, 0x65, 0x2e,
	...
	0x61, 0x6d, 0x69, 0x6e, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5b, 0x0a, 0x04, 0x43,
	...
	,
	...
	,
}

var (
	file_atomone_base_v1beta1_coin_proto_rawDescOnce sync.Once
	file_atomone_base_v1beta1_coin_proto_rawDescData = file_atomone_base_v1beta1_coin_proto_rawDesc
)

func file_atomone_base_v1beta1_coin_proto_rawDescGZIP() []byte {
	file_atomone_base_v1beta1_coin_proto_rawDescOnce.Do(func() {
		file_atomone_base_v1beta1_coin_proto_rawDescData = protoimpl.X.CompressGZIP(file_atomone_base_v1beta1_coin_proto_rawDescData)
	})
	return file_atomone_base_v1beta1_coin_proto_rawDescData
}

var file_atomone_base_v1beta1_coin_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_atomone_base_v1beta1_coin_proto_goTypes = []interface{}{
	(*Coin)(nil),     // 0: atomone.base.v1beta1.Coin
	(*DecCoin)(nil),  // 1: atomone.base.v1beta1.DecCoin
	(*IntProto)(nil), // 2: atomone.base.v1beta1.IntProto
	(*DecProto)(nil), // 3: atomone.base.v1beta1.DecProto
}
var file_atomone_base_v1beta1_coin_proto_depIdxs = []int32{
...
func init() { file_atomone_base_v1beta1_coin_proto_init() }
func file_atomone_base_v1beta1_coin_proto_init() {
	if File_atomone_base_v1beta1_coin_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_atomone_base_v1beta1_coin_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Coin); i {
			case 0:
				return &v.state
			case 1:
		...
		file_atomone_base_v1beta1_coin_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_atomone_base_v1beta1_coin_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_atomone_base_v1beta1_coin_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_atomone_base_v1beta1_coin_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_atomone_base_v1beta1_coin_proto_goTypes,
		DependencyIndexes: file_atomone_base_v1beta1_coin_proto_depIdxs,
		MessageInfos:      file_atomone_base_v1beta1_coin_proto_msgTypes,
	}.Build()
	File_atomone_base_v1beta1_coin_proto = out.File
	file_atomone_base_v1beta1_coin_proto_rawDesc = nil
	file_atomone_base_v1beta1_coin_proto_goTypes = nil
	file_atomone_base_v1beta1_coin_proto_depIdxs = nil
}
