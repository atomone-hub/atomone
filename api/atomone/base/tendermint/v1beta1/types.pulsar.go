...
import (
	...
	version "github.com/atomone-hub/atomone/api/tendermint/version"
...
func init() {
	...
	md_Block = File_atomone_base_tendermint_v1beta1_types_proto.Messages().ByName("Block")
...
func (x *Block) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_base_tendermint_v1beta1_types_proto_msgTypes[0]
...
func (x *fastReflection_Block) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "atomone.base.tendermint.v1beta1.Block.header":
		return x.Header != nil
	case "atomone.base.tendermint.v1beta1.Block.data":
		return x.Data != nil
	case "atomone.base.tendermint.v1beta1.Block.evidence":
		return x.Evidence != nil
	case "atomone.base.tendermint.v1beta1.Block.last_commit":
		return x.LastCommit != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.base.tendermint.v1beta1.Block"))
		}
		panic(fmt.Errorf("message atomone.base.tendermint.v1beta1.Block does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Block) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.base.tendermint.v1beta1.Block does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Block) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.base.tendermint.v1beta1.Block", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_atomone_base_tendermint_v1beta1_types_proto_init()
	md_Header = File_atomone_base_tendermint_v1beta1_types_proto.Messages().ByName("Header")
...
func (x *Header) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_base_tendermint_v1beta1_types_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Header) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "atomone.base.tendermint.v1beta1.Header.version":
		return x.Version != nil
	case "atomone.base.tendermint.v1beta1.Header.chain_id":
		return x.ChainId != ""
	case "atomone.base.tendermint.v1beta1.Header.height":
		return x.Height != int64(0)
	case "atomone.base.tendermint.v1beta1.Header.time":
		return x.Time != nil
	case "atomone.base.tendermint.v1beta1.Header.last_block_id":
		return x.LastBlockId != nil
	case "atomone.base.tendermint.v1beta1.Header.last_commit_hash":
		return len(x.LastCommitHash) != 0
	case "atomone.base.tendermint.v1beta1.Header.data_hash":
		return len(x.DataHash) != 0
	case "atomone.base.tendermint.v1beta1.Header.validators_hash":
		return len(x.ValidatorsHash) != 0
	case "atomone.base.tendermint.v1beta1.Header.next_validators_hash":
		return len(x.NextValidatorsHash) != 0
	case "atomone.base.tendermint.v1beta1.Header.consensus_hash":
		return len(x.ConsensusHash) != 0
	case "atomone.base.tendermint.v1beta1.Header.app_hash":
		return len(x.AppHash) != 0
	case "atomone.base.tendermint.v1beta1.Header.last_results_hash":
		return len(x.LastResultsHash) != 0
	case "atomone.base.tendermint.v1beta1.Header.evidence_hash":
		return len(x.EvidenceHash) != 0
	case "atomone.base.tendermint.v1beta1.Header.proposer_address":
		return x.ProposerAddress != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.base.tendermint.v1beta1.Header"))
		}
		panic(fmt.Errorf("message atomone.base.tendermint.v1beta1.Header does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Header) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.base.tendermint.v1beta1.Header does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Header) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "atomone.base.tendermint.v1beta1.Header.chain_id":
		panic(fmt.Errorf("field chain_id of message atomone.base.tendermint.v1beta1.Header is not mutable"))
	case "atomone.base.tendermint.v1beta1.Header.height":
		panic(fmt.Errorf("field height of message atomone.base.tendermint.v1beta1.Header is not mutable"))
	case "atomone.base.tendermint.v1beta1.Header.last_commit_hash":
		panic(fmt.Errorf("field last_commit_hash of message atomone.base.tendermint.v1beta1.Header is not mutable"))
	case "atomone.base.tendermint.v1beta1.Header.data_hash":
		panic(fmt.Errorf("field data_hash of message atomone.base.tendermint.v1beta1.Header is not mutable"))
	case "atomone.base.tendermint.v1beta1.Header.validators_hash":
		panic(fmt.Errorf("field validators_hash of message atomone.base.tendermint.v1beta1.Header is not mutable"))
	case "atomone.base.tendermint.v1beta1.Header.next_validators_hash":
		panic(fmt.Errorf("field next_validators_hash of message atomone.base.tendermint.v1beta1.Header is not mutable"))
	case "atomone.base.tendermint.v1beta1.Header.consensus_hash":
		panic(fmt.Errorf("field consensus_hash of message atomone.base.tendermint.v1beta1.Header is not mutable"))
	case "atomone.base.tendermint.v1beta1.Header.app_hash":
		panic(fmt.Errorf("field app_hash of message atomone.base.tendermint.v1beta1.Header is not mutable"))
	case "atomone.base.tendermint.v1beta1.Header.last_results_hash":
		panic(fmt.Errorf("field last_results_hash of message atomone.base.tendermint.v1beta1.Header is not mutable"))
	case "atomone.base.tendermint.v1beta1.Header.evidence_hash":
		panic(fmt.Errorf("field evidence_hash of message atomone.base.tendermint.v1beta1.Header is not mutable"))
	case "atomone.base.tendermint.v1beta1.Header.proposer_address":
		panic(fmt.Errorf("field proposer_address of message atomone.base.tendermint.v1beta1.Header is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.base.tendermint.v1beta1.Header"))
		}
...
func (x *fastReflection_Header) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.base.tendermint.v1beta1.Header", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: atomone/base/tendermint/v1beta1/types.proto
...
func (*Block) Descriptor() ([]byte, []int) {
	return file_atomone_base_tendermint_v1beta1_types_proto_rawDescGZIP(), []int{0}
}
...
func (*Header) Descriptor() ([]byte, []int) {
	return file_atomone_base_tendermint_v1beta1_types_proto_rawDescGZIP(), []int{1}
}
...
var File_atomone_base_tendermint_v1beta1_types_proto protoreflect.FileDescriptor

var file_atomone_base_tendermint_v1beta1_types_proto_rawDesc = []byte{
	...
	0x31, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x1f, 0x61,
	...
	0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8c, 0x02, 0x0a, 0x05, 0x42, 0x6c, 0x6f, 0x63,
	0x6b, 0x12, 0x4a, 0x0a, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x27, 0x2e, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2e, 0x62, 0x61, 0x73, 0x65,
	...
	0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65, 0x72, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x42, 0xa6,
	0x02, 0x0a, 0x23, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2e, 0x62,
	...
	0x69, 0x6e, 0x74, 0x76, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0xa2, 0x02, 0x03, 0x41, 0x42, 0x54,
	0xaa, 0x02, 0x1f, 0x41, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2e, 0x42, 0x61, 0x73, 0x65, 0x2e,
	0x54, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x74, 0x2e, 0x56, 0x31, 0x62, 0x65, 0x74,
	0x61, 0x31, 0xca, 0x02, 0x1f, 0x41, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x5c, 0x42, 0x61, 0x73,
	0x65, 0x5c, 0x54, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x74, 0x5c, 0x56, 0x31, 0x62,
	0x65, 0x74, 0x61, 0x31, 0xe2, 0x02, 0x2b, 0x41, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x5c, 0x42,
	...
	0x74, 0x61, 0xea, 0x02, 0x22, 0x41, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x3a, 0x3a, 0x42, 0x61,
	0x73, 0x65, 0x3a, 0x3a, 0x54, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x74, 0x3a, 0x3a,
	0x56, 0x31, 0x62, 0x65, 0x74, 0x61, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_atomone_base_tendermint_v1beta1_types_proto_rawDescOnce sync.Once
	file_atomone_base_tendermint_v1beta1_types_proto_rawDescData = file_atomone_base_tendermint_v1beta1_types_proto_rawDesc
)

func file_atomone_base_tendermint_v1beta1_types_proto_rawDescGZIP() []byte {
	file_atomone_base_tendermint_v1beta1_types_proto_rawDescOnce.Do(func() {
		file_atomone_base_tendermint_v1beta1_types_proto_rawDescData = protoimpl.X.CompressGZIP(file_atomone_base_tendermint_v1beta1_types_proto_rawDescData)
	})
	return file_atomone_base_tendermint_v1beta1_types_proto_rawDescData
}

var file_atomone_base_tendermint_v1beta1_types_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_atomone_base_tendermint_v1beta1_types_proto_goTypes = []interface{}{
	(*Block)(nil),                 // 0: atomone.base.tendermint.v1beta1.Block
	(*Header)(nil),                // 1: atomone.base.tendermint.v1beta1.Header
...
var file_atomone_base_tendermint_v1beta1_types_proto_depIdxs = []int32{
	1, // 0: atomone.base.tendermint.v1beta1.Block.header:type_name -> atomone.base.tendermint.v1beta1.Header
	2, // 1: atomone.base.tendermint.v1beta1.Block.data:type_name -> tendermint.types.Data
	3, // 2: atomone.base.tendermint.v1beta1.Block.evidence:type_name -> tendermint.types.EvidenceList
	4, // 3: atomone.base.tendermint.v1beta1.Block.last_commit:type_name -> tendermint.types.Commit
	5, // 4: atomone.base.tendermint.v1beta1.Header.version:type_name -> tendermint.version.Consensus
	6, // 5: atomone.base.tendermint.v1beta1.Header.time:type_name -> google.protobuf.Timestamp
	7, // 6: atomone.base.tendermint.v1beta1.Header.last_block_id:type_name -> tendermint.types.BlockID
...
func init() { file_atomone_base_tendermint_v1beta1_types_proto_init() }
func file_atomone_base_tendermint_v1beta1_types_proto_init() {
	if File_atomone_base_tendermint_v1beta1_types_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_atomone_base_tendermint_v1beta1_types_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Block); i {
			case 0:
				return &v.state
			case 1:
		...
		file_atomone_base_tendermint_v1beta1_types_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Header); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_atomone_base_tendermint_v1beta1_types_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_atomone_base_tendermint_v1beta1_types_proto_goTypes,
		DependencyIndexes: file_atomone_base_tendermint_v1beta1_types_proto_depIdxs,
		MessageInfos:      file_atomone_base_tendermint_v1beta1_types_proto_msgTypes,
	}.Build()
	File_atomone_base_tendermint_v1beta1_types_proto = out.File
	file_atomone_base_tendermint_v1beta1_types_proto_rawDesc = nil
	file_atomone_base_tendermint_v1beta1_types_proto_goTypes = nil
	file_atomone_base_tendermint_v1beta1_types_proto_depIdxs = nil
}
