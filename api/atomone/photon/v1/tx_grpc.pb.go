...
const (
	Msg_MintPhoton_FullMethodName   = "/atomone.photon.v1.Msg/MintPhoton"
	Msg_UpdateParams_FullMethodName = "/atomone.photon.v1.Msg/UpdateParams"
)
...
func (c *msgClient) MintPhoton(ctx context.Context, in *MsgMintPhoton, opts ...grpc.CallOption) (*MsgMintPhotonResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_MintPhoton_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) MintPhoton(context.Context, *MsgMintPhoton) (*MsgMintPhotonResponse, error) {
...
func _Msg_MintPhoton_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_MintPhoton_FullMethodName,
	}
