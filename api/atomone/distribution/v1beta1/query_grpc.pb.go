...
const (
	Query_Params_FullMethodName                      = "/atomone.distribution.v1beta1.Query/Params"
	Query_ValidatorDistributionInfo_FullMethodName   = "/atomone.distribution.v1beta1.Query/ValidatorDistributionInfo"
	Query_ValidatorOutstandingRewards_FullMethodName = "/atomone.distribution.v1beta1.Query/ValidatorOutstandingRewards"
	Query_ValidatorCommission_FullMethodName         = "/atomone.distribution.v1beta1.Query/ValidatorCommission"
	Query_ValidatorSlashes_FullMethodName            = "/atomone.distribution.v1beta1.Query/ValidatorSlashes"
	Query_DelegationRewards_FullMethodName           = "/atomone.distribution.v1beta1.Query/DelegationRewards"
	Query_DelegationTotalRewards_FullMethodName      = "/atomone.distribution.v1beta1.Query/DelegationTotalRewards"
	Query_DelegatorValidators_FullMethodName         = "/atomone.distribution.v1beta1.Query/DelegatorValidators"
	Query_DelegatorWithdrawAddress_FullMethodName    = "/atomone.distribution.v1beta1.Query/DelegatorWithdrawAddress"
	Query_CommunityPool_FullMethodName               = "/atomone.distribution.v1beta1.Query/CommunityPool"
	Query_Eta_FullMethodName                         = "/atomone.distribution.v1beta1.Query/Eta"
)
