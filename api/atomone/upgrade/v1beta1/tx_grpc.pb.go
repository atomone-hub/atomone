...
const (
	Msg_SoftwareUpgrade_FullMethodName = "/atomone.upgrade.v1beta1.Msg/SoftwareUpgrade"
	Msg_CancelUpgrade_FullMethodName   = "/atomone.upgrade.v1beta1.Msg/CancelUpgrade"
)
