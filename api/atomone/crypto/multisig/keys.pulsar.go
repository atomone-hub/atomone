...
func init() {
	file_atomone_crypto_multisig_keys_proto_init()
	md_LegacyAminoPubKey = File_atomone_crypto_multisig_keys_proto.Messages().ByName("LegacyAminoPubKey")
...
func (x *LegacyAminoPubKey) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_crypto_multisig_keys_proto_msgTypes[0]
...
func (x *fastReflection_LegacyAminoPubKey) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "atomone.crypto.multisig.LegacyAminoPubKey.threshold":
		return x.Threshold != uint32(0)
	case "atomone.crypto.multisig.LegacyAminoPubKey.public_keys":
		return len(x.PublicKeys) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.crypto.multisig.LegacyAminoPubKey"))
		}
		panic(fmt.Errorf("message atomone.crypto.multisig.LegacyAminoPubKey does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_LegacyAminoPubKey) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.crypto.multisig.LegacyAminoPubKey does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_LegacyAminoPubKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "atomone.crypto.multisig.LegacyAminoPubKey.threshold":
		panic(fmt.Errorf("field threshold of message atomone.crypto.multisig.LegacyAminoPubKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.crypto.multisig.LegacyAminoPubKey"))
		}
...
func (x *fastReflection_LegacyAminoPubKey) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.crypto.multisig.LegacyAminoPubKey", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: atomone/crypto/multisig/keys.proto
...
func (*LegacyAminoPubKey) Descriptor() ([]byte, []int) {
	return file_atomone_crypto_multisig_keys_proto_rawDescGZIP(), []int{0}
}
...
var File_atomone_crypto_multisig_keys_proto protoreflect.FileDescriptor

var file_atomone_crypto_multisig_keys_proto_rawDesc = []byte{
	0x0a, 0x22, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2f, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f,
	0x2f, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x73, 0x69, 0x67, 0x2f, 0x6b, 0x65, 0x79, 0x73, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x17, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2e, 0x63, 0x72,
	0x79, 0x70, 0x74, 0x6f, 0x2e, 0x6d, 0x75, 0x6c, 0x74, 0x69, 0x73, 0x69, 0x67, 0x1a, 0x14, 0x67,
	...
	,
	...
	0x6c, 0x64, 0x92, 0xe7, 0xb0, 0x2a, 0x10, 0x74, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64,
	0x5f, 0x73, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x42, 0xe2, 0x01, 0x0a, 0x1b, 0x63, 0x6f, 0x6d, 0x2e,
	0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x2e, 0x6d,
	0x75, 0x6c, 0x74, 0x69, 0x73, 0x69, 0x67, 0x42, 0x09, 0x4b, 0x65, 0x79, 0x73, 0x50, 0x72, 0x6f,
	...
	,
}

var (
	file_atomone_crypto_multisig_keys_proto_rawDescOnce sync.Once
	file_atomone_crypto_multisig_keys_proto_rawDescData = file_atomone_crypto_multisig_keys_proto_rawDesc
)

func file_atomone_crypto_multisig_keys_proto_rawDescGZIP() []byte {
	file_atomone_crypto_multisig_keys_proto_rawDescOnce.Do(func() {
		file_atomone_crypto_multisig_keys_proto_rawDescData = protoimpl.X.CompressGZIP(file_atomone_crypto_multisig_keys_proto_rawDescData)
	})
	return file_atomone_crypto_multisig_keys_proto_rawDescData
}

var file_atomone_crypto_multisig_keys_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_atomone_crypto_multisig_keys_proto_goTypes = []interface{}{
	(*LegacyAminoPubKey)(nil), // 0: atomone.crypto.multisig.LegacyAminoPubKey
	(*anypb.Any)(nil),         // 1: google.protobuf.Any
}
var file_atomone_crypto_multisig_keys_proto_depIdxs = []int32{
	1, // 0: atomone.crypto.multisig.LegacyAminoPubKey.public_keys:type_name -> google.protobuf.Any
...
func init() { file_atomone_crypto_multisig_keys_proto_init() }
func file_atomone_crypto_multisig_keys_proto_init() {
	if File_atomone_crypto_multisig_keys_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_atomone_crypto_multisig_keys_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_atomone_crypto_multisig_keys_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_atomone_crypto_multisig_keys_proto_goTypes,
		DependencyIndexes: file_atomone_crypto_multisig_keys_proto_depIdxs,
		MessageInfos:      file_atomone_crypto_multisig_keys_proto_msgTypes,
	}.Build()
	File_atomone_crypto_multisig_keys_proto = out.File
	file_atomone_crypto_multisig_keys_proto_rawDesc = nil
	file_atomone_crypto_multisig_keys_proto_goTypes = nil
	file_atomone_crypto_multisig_keys_proto_depIdxs = nil
}
