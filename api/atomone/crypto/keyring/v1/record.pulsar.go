...
import (
	fmt "fmt"
	v1 "github.com/atomone-hub/atomone/api/atomone/crypto/hd/v1"
...
func init() {
	file_atomone_crypto_keyring_v1_record_proto_init()
	md_Record = File_atomone_crypto_keyring_v1_record_proto.Messages().ByName("Record")
...
func (x *Record) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_crypto_keyring_v1_record_proto_msgTypes[0]
...
func (x *fastReflection_Record) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "atomone.crypto.keyring.v1.Record.name":
		return x.Name != ""
	case "atomone.crypto.keyring.v1.Record.pub_key":
		return x.PubKey != nil
	case "atomone.crypto.keyring.v1.Record.local":
		if x.Item == nil {
			return false
	...
	case "atomone.crypto.keyring.v1.Record.ledger":
		if x.Item == nil {
			return false
	...
	case "atomone.crypto.keyring.v1.Record.multi":
		if x.Item == nil {
			return false
	...
	case "atomone.crypto.keyring.v1.Record.offline":
		if x.Item == nil {
			return false
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.crypto.keyring.v1.Record"))
		}
		panic(fmt.Errorf("message atomone.crypto.keyring.v1.Record does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Record) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.crypto.keyring.v1.Record does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Record) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "atomone.crypto.keyring.v1.Record.name":
		panic(fmt.Errorf("field name of message atomone.crypto.keyring.v1.Record is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.crypto.keyring.v1.Record"))
		}
...
func (x *fastReflection_Record) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	case "atomone.crypto.keyring.v1.Record.item":
		if x.Item == nil {
			return nil
		}
		switch x.Item.(type) {
	...
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.crypto.keyring.v1.Record", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_atomone_crypto_keyring_v1_record_proto_init()
	md_Record_Local = File_atomone_crypto_keyring_v1_record_proto.Messages().ByName("Record").Messages().ByName("Local")
...
func (x *Record_Local) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_crypto_keyring_v1_record_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Record_Local) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "atomone.crypto.keyring.v1.Record.Local.priv_key":
		return x.PrivKey != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.crypto.keyring.v1.Record.Local"))
		}
		panic(fmt.Errorf("message atomone.crypto.keyring.v1.Record.Local does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Record_Local) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.crypto.keyring.v1.Record.Local does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Record_Local) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.crypto.keyring.v1.Record.Local", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_atomone_crypto_keyring_v1_record_proto_init()
	md_Record_Ledger = File_atomone_crypto_keyring_v1_record_proto.Messages().ByName("Record").Messages().ByName("Ledger")
...
func (x *Record_Ledger) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_crypto_keyring_v1_record_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Record_Ledger) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "atomone.crypto.keyring.v1.Record.Ledger.path":
		return x.Path != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.crypto.keyring.v1.Record.Ledger"))
		}
		panic(fmt.Errorf("message atomone.crypto.keyring.v1.Record.Ledger does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Record_Ledger) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.crypto.keyring.v1.Record.Ledger does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Record_Ledger) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.crypto.keyring.v1.Record.Ledger", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_atomone_crypto_keyring_v1_record_proto_init()
	md_Record_Multi = File_atomone_crypto_keyring_v1_record_proto.Messages().ByName("Record").Messages().ByName("Multi")
}
...
func (x *Record_Multi) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_crypto_keyring_v1_record_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Record_Multi) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.crypto.keyring.v1.Record.Multi"))
		}
		panic(fmt.Errorf("message atomone.crypto.keyring.v1.Record.Multi does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Record_Multi) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.crypto.keyring.v1.Record.Multi does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Record_Multi) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.crypto.keyring.v1.Record.Multi", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_atomone_crypto_keyring_v1_record_proto_init()
	md_Record_Offline = File_atomone_crypto_keyring_v1_record_proto.Messages().ByName("Record").Messages().ByName("Offline")
}
...
func (x *Record_Offline) slowProtoReflect() protoreflect.Message {
	mi := &file_atomone_crypto_keyring_v1_record_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Record_Offline) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: atomone.crypto.keyring.v1.Record.Offline"))
		}
		panic(fmt.Errorf("message atomone.crypto.keyring.v1.Record.Offline does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Record_Offline) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message atomone.crypto.keyring.v1.Record.Offline does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Record_Offline) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in atomone.crypto.keyring.v1.Record.Offline", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: atomone/crypto/keyring/v1/record.proto
...
func (*Record) Descriptor() ([]byte, []int) {
	return file_atomone_crypto_keyring_v1_record_proto_rawDescGZIP(), []int{0}
}
...
func (*Record_Local) Descriptor() ([]byte, []int) {
	return file_atomone_crypto_keyring_v1_record_proto_rawDescGZIP(), []int{0, 0}
}
...
func (*Record_Ledger) Descriptor() ([]byte, []int) {
	return file_atomone_crypto_keyring_v1_record_proto_rawDescGZIP(), []int{0, 1}
}
...
func (*Record_Multi) Descriptor() ([]byte, []int) {
	return file_atomone_crypto_keyring_v1_record_proto_rawDescGZIP(), []int{0, 2}
}
...
func (*Record_Offline) Descriptor() ([]byte, []int) {
	return file_atomone_crypto_keyring_v1_record_proto_rawDescGZIP(), []int{0, 3}
}

var File_atomone_crypto_keyring_v1_record_proto protoreflect.FileDescriptor

var file_atomone_crypto_keyring_v1_record_proto_rawDesc = []byte{
	0x0a, 0x26, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2f, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f,
	0x2f, 0x6b, 0x65, 0x79, 0x72, 0x69, 0x6e, 0x67, 0x2f, 0x76, 0x31, 0x2f, 0x72, 0x65, 0x63, 0x6f,
	0x72, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x19, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e,
	0x65, 0x2e, 0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x2e, 0x6b, 0x65, 0x79, 0x72, 0x69, 0x6e, 0x67,
	...
	0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1d, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2f, 0x63, 0x72,
	0x79, 0x70, 0x74, 0x6f, 0x2f, 0x68, 0x64, 0x2f, 0x76, 0x31, 0x2f, 0x68, 0x64, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x22, 0xef, 0x03, 0x0a, 0x06, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x12,
	...
	,
	...
	0x04, 0x69, 0x74, 0x65, 0x6d, 0x42, 0x83, 0x02, 0xc8, 0xe1, 0x1e, 0x00, 0x98, 0xe3, 0x1e, 0x00,
	0x0a, 0x1d, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2e, 0x63, 0x72,
	0x79, 0x70, 0x74, 0x6f, 0x2e, 0x6b, 0x65, 0x79, 0x72, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x31, 0x42,
	0x0b, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x46,
	...
	0x70, 0x69, 0x2f, 0x61, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2f, 0x63, 0x72, 0x79, 0x70, 0x74,
	0x6f, 0x2f, 0x6b, 0x65, 0x79, 0x72, 0x69, 0x6e, 0x67, 0x2f, 0x76, 0x31, 0x3b, 0x6b, 0x65, 0x79,
	0x72, 0x69, 0x6e, 0x67, 0x76, 0x31, 0xa2, 0x02, 0x03, 0x41, 0x43, 0x4b, 0xaa, 0x02, 0x19, 0x41,
	0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x2e, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x2e, 0x4b, 0x65,
	0x79, 0x72, 0x69, 0x6e, 0x67, 0x2e, 0x56, 0x31, 0xca, 0x02, 0x19, 0x41, 0x74, 0x6f, 0x6d, 0x6f,
	0x6e, 0x65, 0x5c, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x5c, 0x4b, 0x65, 0x79, 0x72, 0x69, 0x6e,
	0x67, 0x5c, 0x56, 0x31, 0xe2, 0x02, 0x25, 0x41, 0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x5c, 0x43,
	...
	0x74, 0x6f, 0x6d, 0x6f, 0x6e, 0x65, 0x3a, 0x3a, 0x43, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x3a, 0x3a,
	0x4b, 0x65, 0x79, 0x72, 0x69, 0x6e, 0x67, 0x3a, 0x3a, 0x56, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}

var (
	file_atomone_crypto_keyring_v1_record_proto_rawDescOnce sync.Once
	file_atomone_crypto_keyring_v1_record_proto_rawDescData = file_atomone_crypto_keyring_v1_record_proto_rawDesc
)

func file_atomone_crypto_keyring_v1_record_proto_rawDescGZIP() []byte {
	file_atomone_crypto_keyring_v1_record_proto_rawDescOnce.Do(func() {
		file_atomone_crypto_keyring_v1_record_proto_rawDescData = protoimpl.X.CompressGZIP(file_atomone_crypto_keyring_v1_record_proto_rawDescData)
	})
	return file_atomone_crypto_keyring_v1_record_proto_rawDescData
}

var file_atomone_crypto_keyring_v1_record_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_atomone_crypto_keyring_v1_record_proto_goTypes = []interface{}{
	(*Record)(nil),         // 0: atomone.crypto.keyring.v1.Record
	(*Record_Local)(nil),   // 1: atomone.crypto.keyring.v1.Record.Local
	(*Record_Ledger)(nil),  // 2: atomone.crypto.keyring.v1.Record.Ledger
	(*Record_Multi)(nil),   // 3: atomone.crypto.keyring.v1.Record.Multi
	(*Record_Offline)(nil), // 4: atomone.crypto.keyring.v1.Record.Offline
	(*anypb.Any)(nil),      // 5: google.protobuf.Any
	(*v1.BIP44Params)(nil), // 6: atomone.crypto.hd.v1.BIP44Params
}
var file_atomone_crypto_keyring_v1_record_proto_depIdxs = []int32{
	5, // 0: atomone.crypto.keyring.v1.Record.pub_key:type_name -> google.protobuf.Any
	1, // 1: atomone.crypto.keyring.v1.Record.local:type_name -> atomone.crypto.keyring.v1.Record.Local
	2, // 2: atomone.crypto.keyring.v1.Record.ledger:type_name -> atomone.crypto.keyring.v1.Record.Ledger
	3, // 3: atomone.crypto.keyring.v1.Record.multi:type_name -> atomone.crypto.keyring.v1.Record.Multi
	4, // 4: atomone.crypto.keyring.v1.Record.offline:type_name -> atomone.crypto.keyring.v1.Record.Offline
	5, // 5: atomone.crypto.keyring.v1.Record.Local.priv_key:type_name -> google.protobuf.Any
	6, // 6: atomone.crypto.keyring.v1.Record.Ledger.path:type_name -> atomone.crypto.hd.v1.BIP44Params
...
func init() { file_atomone_crypto_keyring_v1_record_proto_init() }
func file_atomone_crypto_keyring_v1_record_proto_init() {
	if File_atomone_crypto_keyring_v1_record_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_atomone_crypto_keyring_v1_record_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Record); i {
			case 0:
				return &v.state
			case 1:
		...
		file_atomone_crypto_keyring_v1_record_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_atomone_crypto_keyring_v1_record_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_atomone_crypto_keyring_v1_record_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_atomone_crypto_keyring_v1_record_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_atomone_crypto_keyring_v1_record_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*Record_Local_)(nil),
		(*Record_Ledger_)(nil),
		(*Record_Multi_)(nil),
		(*Record_Offline_)(nil),
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_atomone_crypto_keyring_v1_record_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_atomone_crypto_keyring_v1_record_proto_goTypes,
		DependencyIndexes: file_atomone_crypto_keyring_v1_record_proto_depIdxs,
		MessageInfos:      file_atomone_crypto_keyring_v1_record_proto_msgTypes,
	}.Build()
	File_atomone_crypto_keyring_v1_record_proto = out.File
	file_atomone_crypto_keyring_v1_record_proto_rawDesc = nil
	file_atomone_crypto_keyring_v1_record_proto_goTypes = nil
	file_atomone_crypto_keyring_v1_record_proto_depIdxs = nil
}
