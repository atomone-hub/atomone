...
var pattern_Service_Config_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"atomone", "base", "node", "v1beta1", "config"}, "", runtime.AssumeColonVerbOpt(false)))

var forward_Service_Config_0 = runtime.ForwardResponseMessage
