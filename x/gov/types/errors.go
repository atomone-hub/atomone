...
var (
	...
	ErrUnknownGovernor                = errors.Register(ModuleName, 310, "unknown governor")
	...
	ErrUnknownGovernanceDelegation    = errors.Register(ModuleName, 340, "unknown governance delegation")
	ErrInvalidGovernanceDescription   = errors.Register(ModuleName, 350, "invalid governance description")
	ErrDelegatorIsGovernor            = errors.Register(ModuleName, 360, "cannot delegate, delegator is an active governor")
