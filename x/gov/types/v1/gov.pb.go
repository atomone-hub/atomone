...
type Proposal struct {
	...
	Status ProposalStatus `protobuf:"varint,3,opt,name=status,proto3,enum=atopmone.gov.v1.ProposalStatus" json:"status,omitempty"`
...
func init() { proto.RegisterFile("atomone/gov/v1/gov.proto", fileDescriptor_e05cb1c0d030febb) }
