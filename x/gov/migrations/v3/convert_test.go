...
func TestConvertToLegacyDeposit(t *testing.T) {
	...
	v2beta1Deposit := v3.ConvertToLegacyDeposit(&deposit)
	require.Equal(t, v2beta1Deposit.ProposalId, deposit.ProposalId)
	require.Equal(t, v2beta1Deposit.Depositor, deposit.Depositor)
	require.Equal(t, v2beta1Deposit.Amount[0], deposit.Amount[0])
}
