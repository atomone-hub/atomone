...
func (s *CLITestSuite) TestTxCreateGroupWithPolicy() {
	...
	thresholdDecisionPolicyFile := testutil.WriteToNewTempFile(s.T(), `{"@type": "/atomone.group.v1.ThresholdDecisionPolicy","threshold": "1","windows": {"voting_period":"1s"}}`)
...
func (s *CLITestSuite) TestTxCreateGroupPolicy() {
	...
	percentageDecisionPolicyFile := testutil.WriteToNewTempFile(s.T(), `{"@type":"/atomone.group.v1.PercentageDecisionPolicy", "percentage":"0.5", "windows":{"voting_period":"1s"}}`)
	invalidNegativePercentageDecisionPolicyFile := testutil.WriteToNewTempFile(s.T(), `{"@type":"/atomone.group.v1.PercentageDecisionPolicy", "percentage":"-0.5", "windows":{"voting_period":"1s"}}`)
	invalidPercentageDecisionPolicyFile := testutil.WriteToNewTempFile(s.T(), `{"@type":"/atomone.group.v1.PercentageDecisionPolicy", "percentage":"2", "windows":{"voting_period":"1s"}}`)
...
func (s *CLITestSuite) TestTxUpdateGroupPolicyDecisionPolicy() {
	...
	thresholdDecisionPolicy := testutil.WriteToNewTempFile(s.T(), `{"@type":"/atomone.group.v1.ThresholdDecisionPolicy", "threshold":"1", "windows":{"voting_period":"40000s"}}`)
	percentageDecisionPolicy := testutil.WriteToNewTempFile(s.T(), `{"@type":"/atomone.group.v1.PercentageDecisionPolicy", "percentage":"0.5", "windows":{"voting_period":"40000s"}}`)
	invalidNegativePercentageDecisionPolicy := testutil.WriteToNewTempFile(s.T(), `{"@type":"/atomone.group.v1.PercentageDecisionPolicy", "percentage":"-0.5", "windows":{"voting_period":"1s"}}`)
	invalidPercentageDecisionPolicy := testutil.WriteToNewTempFile(s.T(), `{"@type":"/atomone.group.v1.PercentageDecisionPolicy", "percentage":"2", "windows":{"voting_period":"40000s"}}`)
