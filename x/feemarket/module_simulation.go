...
// GenerateGenesisState returns a disabled feemarket module because the module
// does not work well with simulations. Especially the feemarket ante handler
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	fmt.Println("Feemarket module is disabled")
}
