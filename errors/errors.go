...
func ABCIError(codespace string, code uint32, log string) error {
	if e := getUsed(codespace, code); e != nil {
		return Wrap(e, log) //nolint: staticcheck
	}
	// This is a unique error, will never match on .Is()
	// Use Wrap here to get a stack trace
	return Wrap(&Error{codespace: codespace, code: code, desc: "unknown"}, log) //nolint: staticcheck
}
...
func (e *Error) Wrap(desc string) error { return Wrap(e, desc) } //nolint: staticcheck

// Wrapf extends this error with an additional information.
// It's a handy function to call Wrapf with sdk errors.
func (e *Error) Wrapf(desc string, args ...interface{}) error { return Wrapf(e, desc, args...) } //nolint: staticcheck
...
func Wrap(err error, description string) error { //nolint: staticcheck
	if err == nil {
		return nil
	}
...
func Wrapf(err error, format string, args ...interface{}) error {
	...
	return Wrap(err, desc) //nolint: staticcheck
}
...
func WithType(err error, obj interface{}) error {
	return Wrap(err, fmt.Sprintf("%T", obj)) //nolint: staticcheck
}
