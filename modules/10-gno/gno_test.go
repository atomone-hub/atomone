...
func TestGnoTestSuite(t *testing.T) {
	testifysuite.Run(t, new(GnoTestSuite))
}

func (s *GnoTestSuite) SetupTest() {
...
func getBothSigners(s *GnoTestSuite, altVal *cmttypes.Validator, altPrivVal cmttypes.PrivValidator) (*cmttypes.ValidatorSet, map[string]cmttypes.PrivValidator) {
