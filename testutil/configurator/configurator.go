	...
	return func(config *Config) {
		config.ModuleConfigs["mint"] = &appv1alpha1.ModuleConfig{
			...
			GolangBindings: []*appv1alpha1.GolangBinding{
				{
					InterfaceType:  "github.com/atomone-hub/atomone/x/mint/types/types.StakingKeeper",
					Implementation: "github.com/atomone-hub/atomone/x/staking/keeper/*keeper.Keeper",
				},
			},
		}
	}
