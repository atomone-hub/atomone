...
func modifyGenesis(cdc codec.Codec, path, moniker, amountStr string, addrAll []sdk.AccAddress, denom string) error {
	...
	icaGenesisState.HostGenesisState.Params.AllowMessages = []string{
		...
		"/atomone.distribution.v1beta1.MsgSetWithdrawAddress",
		"/atomone.distribution.v1beta1.MsgWithdrawValidatorCommission",
		"/atomone.distribution.v1beta1.MsgFundCommunityPool",
		"/atomone.distribution.v1beta1.MsgWithdrawDelegatorReward",
