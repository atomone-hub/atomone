...
// */
const (
	valSetLatestPath                    = "/atomone/base/tendermint/v1beta1/validatorsets/latest"
	valSetHeightPath                    = "/atomone/base/tendermint/v1beta1/validatorsets/1"
	blocksLatestPath                    = "/atomone/base/tendermint/v1beta1/blocks/latest"
	blocksHeightPath                    = "/atomone/base/tendermint/v1beta1/blocks/1"
	syncingPath                         = "/atomone/base/tendermint/v1beta1/syncing"
	nodeInfoPath                        = "/atomone/base/tendermint/v1beta1/node_info"
	transactionsPath                    = "/atomone/tx/v1beta1/txs?events=tx.height=9999999999"
	bankTotalModuleQueryPath            = "/atomone/bank/v1beta1/supply"
	authParamsModuleQueryPath           = "/atomone/auth/v1beta1/params"
	distributionCommPoolModuleQueryPath = "/atomone/distribution/v1beta1/community_pool"
	evidenceModuleQueryPath             = "/atomone/evidence/v1beta1/evidence"
	govPropsModuleQueryPath             = "/atomone/gov/v1beta1/proposals"
	mintParamsModuleQueryPath           = "/atomone/mint/v1beta1/params"
	slashingParamsModuleQueryPath       = "/atomone/slashing/v1beta1/params"
	stakingParamsModuleQueryPath        = "/atomone/staking/v1beta1/params"
	missingPath                         = "/missing_endpoint"
	localMinGasPriceQueryPath           = "/atomone/base/node/v1beta1/config"
)
